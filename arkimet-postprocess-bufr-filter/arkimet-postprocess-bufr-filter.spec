Name:           arkimet-postprocess-bufr-filter
Version:        0.1
Release:        1%{?dist}
...
%description
Postprocessor to filter BUFR data
...
%changelog
* Thu May 25 2017 Emanuele Di Giacomo <edigiacomo@arpae.it> - 0.1-1
- First version
